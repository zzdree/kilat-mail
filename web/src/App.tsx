    ...
    <div className="min-h-screen w-full bg-[#0B0F19] text-gray-100 flex flex-col items-center selection:bg-amber-500 selection:text-black">
      ...
      <main className="flex-1 w-full max-w-3xl px-4 py-6 sm:py-10 flex flex-col">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-[11px] sm:text-xs font-semibold mb-3">
          ...
          <h1 className="text-2xl sm:text-4xl font-extrabold tracking-tight text-white mb-2 leading-tight">
            Email Sementara <span className="text-amber-400">Super Cepat</span>
          </h1>

          <p className="text-xs sm:text-sm text-gray-400 max-w-md mx-auto leading-relaxed">
            Terima kode OTP instan & lindungi privasi email utama kamu dari spam.
          </p>
        </div>
        ...
        {/* Value Props */}
        <div className="pt-8 border-t border-gray-800/80 w-full">
          <div className="text-center mb-6">
            <h2 className="text-base sm:text-lg font-bold text-white mb-1">
              Keunggulan Kilat Mail
            </h2>
            <p className="text-xs text-gray-400">
              Dirancang dengan presisi untuk kenyamanan dan privasi pengunjung.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 mb-8">
            <div className="bg-[#111827] border border-gray-800/90 rounded-2xl p-4.5 hover:border-amber-500/40 transition-colors shadow-lg">
              ...
              <h3 className="text-xs sm:text-sm font-bold text-white mb-1">Smart OTP Extractor</h3>
              <p className="text-[11px] sm:text-xs text-gray-400 leading-relaxed">
                Mendeteksi kode verifikasi secara otomatis dari email untuk disalin langsung dalam 1 klik.
              </p>
            </div>

            <div className="bg-[#111827] border border-gray-800/90 rounded-2xl p-4.5 hover:border-cyan-500/40 transition-colors shadow-lg">
              ...
              <h3 className="text-xs sm:text-sm font-bold text-white mb-1">100% Privasi & Bersih</h3>
              <p className="text-[11px] sm:text-xs text-gray-400 leading-relaxed">
                Tanpa registrasi, tanpa tracking cookie, dan konten HTML dibersihkan dengan DOMPurify.
              </p>
            </div>

            <div className="bg-[#111827] border border-gray-800/90 rounded-2xl p-4.5 hover:border-emerald-500/40 transition-colors shadow-lg">
              ...
              <h3 className="text-xs sm:text-sm font-bold text-white mb-1">Cloudflare Edge</h3>
              <p className="text-[11px] sm:text-xs text-gray-400 leading-relaxed">
                Ditenagai Cloudflare Email Routing & Workers untuk latensi penerimaan super rendah.
              </p>
            </div>
          </div>

          {/* FAQ */}
          <div className="bg-[#111827] border border-gray-800 rounded-2xl p-5 sm:p-6 mb-8 shadow-xl">
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="w-full px-3.5 py-3 text-left flex items-center justify-between gap-3 text-xs sm:text-sm font-semibold text-gray-200 hover:text-amber-400 transition-colors"
                    >
                      <span>{faq.q}</span>
                      {isOpen ? (
                    ...
                    {isOpen && (
                      <div className="px-3.5 pb-3 pt-1 text-xs text-gray-400 leading-relaxed border-t border-gray-800/60">
                        {faq.a}
                      </div>
                    )}
                  </div>
      ...
      {/* Footer */}
      <footer className="w-full border-t border-gray-800/80 py-5 px-4 text-center text-xs text-gray-500 bg-[#0B0F19]">
